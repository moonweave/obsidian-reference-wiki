...
All notable public changes are recorded here. This project uses prerelease
tags while the first-user beta gate remains open.
...
- Added standalone release smoke tests and one-paper maintainer dogfooding.
...
[Unreleased]: https://github.com/moonweave/obsidian-reference-wiki/compare/v0.1.0-beta.1...HEAD
